...
#print(df)
    ...
    one_week_sorted_df.to_csv('1_w.csv', index=False)

    
    
    
    csv_file.close()
    xtc = pd.read_csv('1_w.csv')
...
#print(df)
    ...
    one_week_sorted_df.to_csv('1_m.csv', index=False)
    csv_file.close()
...
#print(df)
    ...
    one_week_sorted_df.to_csv('3_m.csv', index=False)
    csv_file.close()
    return one_week_sorted_df
def d():
...
#print(df)
    ...
    one_week_sorted_df.to_csv('6_m.csv', index=False)
    csv_file.close()
    return one_week_sorted_df
def e():
...
#print(df)
    ...
    one_week_sorted_df.to_csv('1_y.csv', index=False)
    csv_file.close()
    return one_week_sorted_df
def f():
...
#print(df)
    ...
    one_week_sorted_df.to_csv('3_y.csv', index=False)
    csv_file.close()
    return one_week_sorted_df
def g():
    ...
    one_week_sorted_df.to_csv('5_y.csv', index=False)
    csv_file.close()
    return one_week_sorted_df